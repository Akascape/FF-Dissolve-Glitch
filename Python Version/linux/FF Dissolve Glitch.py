...
flabel.grid()
Vdo=Button(root, width=42,bg="#82CC6C",fg="white",highlightthickness=1,borderwidth=0.2,text="OPEN",font=(font_name,10),relief="groove", command=openfile)
Vdo.grid()
...
infobtn= Button(root, width=2,bg="#FFFFFF",fg="black", text="ⓘ",relief="sunken",cursor='hand2',font=(font_name,10), highlightthickness=0,borderwidth=0,padx=0,pady=0,command=info)
